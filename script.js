/*Code inspired from http://simonsarris.com/blog/510-making-html5-canvas-useful*/
...
function init() {
  ...
  s.addShape(new Rectangle(40,40,50,50)); // The default is gray
  s.addShape(new Rectangle(60,140,40,60, 'lightskyblue'));
  // Lets make some partially transparent
  s.addShape(new Rectangle(80,150,60,30, 'rgba(127, 255, 212, .5)'));
  s.addShape(new Rectangle(125,80,30,80, 'rgba(245, 222, 179, .7)'));
  s.addShape(new Circle(125,80,30, 'rgba(245, 222, 179, .7)'));
  s.addShape(new Text(125,80,'20pt Calibri', 'rgba(245, 222, 179, .7)',"mayank"));
}
